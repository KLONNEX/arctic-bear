...
if __name__ == '__main__':
    ...
    global_predictor = Predictor(weights='yolo_weights/best.pt')

    with torch.no_grad():
        results = global_predictor.predict(
            path_to_image_or_dir='/home/goncharenko/work/hackaton/polar_bear_AI_HACK/min_of_nature/find_bear/arctic_with_bears/images'
        )
